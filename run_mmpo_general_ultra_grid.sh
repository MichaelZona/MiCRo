...
for m_step_updates in 1 2; do
  for em_temperature in 1.0 1.2 1.5 2.0; do
    tag="mmpo_general_grid_${data_path}_heads${num_heads}_epochs${num_train_epochs}_temp${em_temperature}_mstep${m_step_updates}_seed${seed}"
